...
pickle.dump(metrics.classification_report(y_test,YPred), open("classification_report_decision_tree.pkl", "wb"))
...
def make_confusion_matrix(cf,
    ...
    if title:
        plt.title(title)
    f.savefig("Logistic_Regression_confusion_matrix.pdf", bbox_inches='tight')
...
make_confusion_matrix(confusion_matrix,
                      ...
                      cmap='BuGn', title='Confusion Matrix: Logistic Rgression model')
