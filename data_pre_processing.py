...
# FullTrain.csv must be in the same folder as the .py file. currently running on only 5 of the hundreds of rows for quicker execution
tweetsDataframe = pd.read_csv('FullTrain.csv', nrows=5) # For the entire training dataset, get rid of the nrows attribute.
...
tweetsDataframe.to_csv('dataset_cleaned_tweets.csv')
