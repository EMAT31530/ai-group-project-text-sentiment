...
clf = RandomForestClassifier(n_estimators=10, max_leaf_nodes=336, max_depth=90)
...
def make_confusion_matrix(cf,
    ...
    if title:
        plt.title(title)
    f.savefig("Random_Forest_confusion_matrix.pdf", bbox_inches='tight')
...
make_confusion_matrix(confusion_matrix,
                      ...
                      cmap='Greys', title='Confusion Matrix: Random Forest model')
